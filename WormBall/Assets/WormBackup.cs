...
//	void RemoveSegment()
//	{
//		Transform prevSeg = segments[segments.Length - 1];
//		
...
//				triangleList.Add((i - 1) * 4 + 10);
//				
//				//SetupSquareUV((i - 1) * 4 + 9, (i - 1) * 4 + 10, i * 4 + 7, i * 4 + 8);
//			}
//			
//			triangleList.Add(i * 4 + 7);
//			triangleList.Add(i * 4 + 8);
...
//				triangleList.Add(i * 4 + 9);
//				
//				//SetupSquareUV(i * 4 + 9, i * 4 + 10, i * 4 + 11, i * 4 + 12);
//				
...
//				triangleList.Add(i * 4 + 14);
//				
//				// SetupTriangleUV(i * 4 + 13, i * 4 + 14, i * 4 + 15);
...
//					
//					uvs[++uvIndex] = new Vector2(1.0f, currentUVY - segH/segW);
//				}
//			}
//		}
//		
...
//		
//		ChangeHeadSize(carryScale.y);
//		ChangeSegmentSize(0, carryScale.y);
//		ChangeSegmentSize(1, (carryScale.x + carryScale.y)/2.0f);
//		
//		for(int i = 2; i < segmentNum; i++)
//		{
//			ChangeSegmentSize(i, carryScale.x);
//		}
//	}
//	
//	public void Puke()
...
//				ballObj.transform.localScale = Vector3.one * 0.1f;
//				
...
//		{
//			Vector3 screenVec = Camera.main.WorldToScreenPoint(transform.position + transform.rotation * vertices[i]);
